...
The database is prefilled with Pokémon card data using a .sql file generated by the loaddb module. The loader module retrieves the 151 original Pokémon from the public Pokémon TCG API (https://docs.pokemontcg.io/
